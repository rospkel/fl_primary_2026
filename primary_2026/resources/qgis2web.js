...
map.getView().fit([-8988468.391440, 2948953.008940, -8890720.780546, 3051371.154142], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Primary Results 2026</h2>';
        return titleElement;
    })(),
