...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            //extent: [-9755472.553054, 2801775.389195, -8902699.314814, 3632875.611156],
            units: 'm'
        })
    })
});
...
map.getView().fit([-9049532.522614, 2883689.625308, -8748653.952500, 3019279.218337], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">DSA-Positive Districts</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (56 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Don\'t open too many of these at once, it will cause lag.';
            }
