...
//ol.proj.get("EPSG:3857").setExtent([-8971304.368508, 2956897.393026, -8825908.966186, 3007743.490412]);
var wms_layers = [];
...
var lyr_TurnoutMiamiDade_1 = new ol.layer.Vector({
    ...
    <img src="styles/legend/TurnoutMiamiDade_1_0.png" /> 0 - 0.25<br />\
    <img src="styles/legend/TurnoutMiamiDade_1_1.png" /> 0.25 - 0.5<br />\
    <img src="styles/legend/TurnoutMiamiDade_1_2.png" /> 0.5 - 0.75<br />\
    <img src="styles/legend/TurnoutMiamiDade_1_3.png" /> 0.75 - 1<br />' });
var format_2024PresidentMiamiDadeHarris_2 = new ol.format.GeoJSON();
var features_2024PresidentMiamiDadeHarris_2 = format_2024PresidentMiamiDadeHarris_2.readFeatures(json_2024PresidentMiamiDadeHarris_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_2024PresidentMiamiDadeHarris_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_2024PresidentMiamiDadeHarris_2.addFeatures(features_2024PresidentMiamiDadeHarris_2);
var lyr_2024PresidentMiamiDadeHarris_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_2024PresidentMiamiDadeHarris_2, 
                style: style_2024PresidentMiamiDadeHarris_2,
                popuplayertitle: '2024 President Miami Dade - Harris %',
                interactive: true,
    title: '2024 President Miami Dade - Harris %<br />\
    <img src="styles/legend/2024PresidentMiamiDadeHarris_2_0.png" /> 0 - 0.25<br />\
    <img src="styles/legend/2024PresidentMiamiDadeHarris_2_1.png" /> 0.25 - 0.5<br />\
    <img src="styles/legend/2024PresidentMiamiDadeHarris_2_2.png" /> 0.5 - 0.75<br />\
    <img src="styles/legend/2024PresidentMiamiDadeHarris_2_3.png" /> 0.75 - 1<br />' });
var format_2026SenatePrimaryMiamiDadeNixon_3 = new ol.format.GeoJSON();
var features_2026SenatePrimaryMiamiDadeNixon_3 = format_2026SenatePrimaryMiamiDadeNixon_3.readFeatures(json_2026SenatePrimaryMiamiDadeNixon_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_2026SenatePrimaryMiamiDadeNixon_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_2026SenatePrimaryMiamiDadeNixon_3.addFeatures(features_2026SenatePrimaryMiamiDadeNixon_3);
var lyr_2026SenatePrimaryMiamiDadeNixon_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_2026SenatePrimaryMiamiDadeNixon_3, 
                style: style_2026SenatePrimaryMiamiDadeNixon_3,
                popuplayertitle: '2026 Senate Primary Miami Dade - Nixon %',
                interactive: true,
    title: '2026 Senate Primary Miami Dade - Nixon %<br />\
    <img src="styles/legend/2026SenatePrimaryMiamiDadeNixon_3_0.png" /> 0 - 0.25<br />\
    <img src="styles/legend/2026SenatePrimaryMiamiDadeNixon_3_1.png" /> 0.25 - 0.5<br />\
    <img src="styles/legend/2026SenatePrimaryMiamiDadeNixon_3_2.png" /> 0.5 - 0.75<br />\
    <img src="styles/legend/2026SenatePrimaryMiamiDadeNixon_3_3.png" /> 0.75 - 1<br />' });
...
var lyr_CountyCommissionerDistrict5PiperOverperformance_4 = new ol.layer.Vector({
    ...
    <img src="styles/legend/CountyCommissionerDistrict5PiperOverperformance_4_0.png" /> 0.09 - 0.19<br />\
    <img src="styles/legend/CountyCommissionerDistrict5PiperOverperformance_4_1.png" /> 0.19 - 0.3<br />\
    <img src="styles/legend/CountyCommissionerDistrict5PiperOverperformance_4_2.png" /> 0.3 - 0.4<br />\
    <img src="styles/legend/CountyCommissionerDistrict5PiperOverperformance_4_3.png" /> 0.4 - 0.56<br />' });
var format_StateRepDist108Escarment_5 = new ol.format.GeoJSON();
var features_StateRepDist108Escarment_5 = format_StateRepDist108Escarment_5.readFeatures(json_StateRepDist108Escarment_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_StateRepDist108Escarment_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_StateRepDist108Escarment_5.addFeatures(features_StateRepDist108Escarment_5);
var lyr_StateRepDist108Escarment_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_StateRepDist108Escarment_5, 
                style: style_StateRepDist108Escarment_5,
                popuplayertitle: 'State Rep Dist 108 - Escarment %',
                interactive: true,
    title: 'State Rep Dist 108 - Escarment %<br />\
    <img src="styles/legend/StateRepDist108Escarment_5_0.png" /> 0 - 0.25<br />\
    <img src="styles/legend/StateRepDist108Escarment_5_1.png" /> 0.25 - 0.5<br />\
    <img src="styles/legend/StateRepDist108Escarment_5_2.png" /> 0.5 - 0.75<br />\
    <img src="styles/legend/StateRepDist108Escarment_5_3.png" /> 0.75 - 1<br />' });
var format_StateRepDist109BushIII_6 = new ol.format.GeoJSON();
var features_StateRepDist109BushIII_6 = format_StateRepDist109BushIII_6.readFeatures(json_StateRepDist109BushIII_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_StateRepDist109BushIII_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_StateRepDist109BushIII_6.addFeatures(features_StateRepDist109BushIII_6);
var lyr_StateRepDist109BushIII_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_StateRepDist109BushIII_6, 
                style: style_StateRepDist109BushIII_6,
                popuplayertitle: 'State Rep Dist 109 - Bush III %',
                interactive: true,
    title: 'State Rep Dist 109 - Bush III %<br />\
    <img src="styles/legend/StateRepDist109BushIII_6_0.png" /> 0 - 0.25<br />\
    <img src="styles/legend/StateRepDist109BushIII_6_1.png" /> 0.25 - 0.5<br />\
    <img src="styles/legend/StateRepDist109BushIII_6_2.png" /> 0.5 - 0.75<br />\
    <img src="styles/legend/StateRepDist109BushIII_6_3.png" /> 0.75 - 1<br />' });
...
lyr_ESRIGraylight_0.setVisible(true);lyr_TurnoutMiamiDade_1.setVisible(false);lyr_2024PresidentMiamiDadeHarris_2.setVisible(false);lyr_2026SenatePrimaryMiamiDadeNixon_3.setVisible(false);lyr_CountyCommissionerDistrict5PiperOverperformance_4.setVisible(false);lyr_StateRepDist108Escarment_5.setVisible(false);lyr_StateRepDist109BushIII_6.setVisible(false);lyr_FLStateSenateDistricts2022_7.setVisible(false);lyr_FLStateHouseDistricts2022_8.setVisible(false);lyr_FLCongressionalDistricts2026_9.setVisible(false);lyr_MiamiDadeCountyCommissionDistricts_10.setVisible(false);lyr_MunicipalitiesMiamiDade2026_11.setVisible(false);lyr_MiamiCityCommissionDistricts2026_12.setVisible(false);
var layersList = [lyr_ESRIGraylight_0,lyr_TurnoutMiamiDade_1,lyr_2024PresidentMiamiDadeHarris_2,lyr_2026SenatePrimaryMiamiDadeNixon_3,lyr_CountyCommissionerDistrict5PiperOverperformance_4,lyr_StateRepDist108Escarment_5,lyr_StateRepDist109BushIII_6,lyr_FLStateSenateDistricts2022_7,lyr_FLStateHouseDistricts2022_8,lyr_FLCongressionalDistricts2026_9,lyr_MiamiDadeCountyCommissionDistricts_10,lyr_MunicipalitiesMiamiDade2026_11,lyr_MiamiCityCommissionDistricts2026_12];
...
lyr_2024PresidentMiamiDadeHarris_2.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'ID': 'Precinct', 'GlobalID': 'GlobalID', 'Shape__Are': 'Shape__Are', 'Shape__Len': 'Shape__Len', 'President and Vice President-results-Miami-Dade_Chase Oliver': 'President and Vice President-results-Miami-Dade_Chase Oliver', 'President and Vice President-results-Miami-Dade_Claudia De la Cruz': 'President and Vice President-results-Miami-Dade_Claudia De la Cruz', 'President and Vice President-results-Miami-Dade_Donald J. Trump': 'Trump', 'President and Vice President-results-Miami-Dade_Jill Stein': 'President and Vice President-results-Miami-Dade_Jill Stein', 'President and Vice President-results-Miami-Dade_Kamala D. Harris': 'Harris', 'President and Vice President-results-Miami-Dade_Peter Sonski': 'President and Vice President-results-Miami-Dade_Peter Sonski', 'President and Vice President-results-Miami-Dade_Randall Terry': 'President and Vice President-results-Miami-Dade_Randall Terry', 'President and Vice President-results-Miami-Dade_Winner': 'Winner', 'President and Vice President-results-Miami-Dade_Chase Oliver %': 'President and Vice President-results-Miami-Dade_Chase Oliver %', 'President and Vice President-results-Miami-Dade_Claudia De la Cruz %': 'President and Vice President-results-Miami-Dade_Claudia De la Cruz %', 'President and Vice President-results-Miami-Dade_Donald J. Trump %': 'Trump %', 'President and Vice President-results-Miami-Dade_Jill Stein %': 'President and Vice President-results-Miami-Dade_Jill Stein %', 'President and Vice President-results-Miami-Dade_Kamala D. Harris %': 'Harris %', 'President and Vice President-results-Miami-Dade_Peter Sonski %': 'President and Vice President-results-Miami-Dade_Peter Sonski %', 'President and Vice President-results-Miami-Dade_Randall Terry %': 'President and Vice President-results-Miami-Dade_Randall Terry %', });
lyr_2026SenatePrimaryMiamiDadeNixon_3.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'ID': 'Precinct', 'GlobalID': 'GlobalID', 'Shape__Are': 'Shape__Are', 'Shape__Len': 'Shape__Len', 'DEM United States Senator-results-Miami-Dade_Alex Vindman': 'Vindman', 'DEM United States Senator-results-Miami-Dade_Angie Nixon': 'Nixon', 'DEM United States Senator-results-Miami-Dade_Winner': 'Winner', 'DEM United States Senator-results-Miami-Dade_Alex Vindman %': 'Vindman %', 'DEM United States Senator-results-Miami-Dade_Angie Nixon %': 'Nixon %', });
...
lyr_StateRepDist108Escarment_5.set('fieldAliases', {'fid': 'fid', 'OBJECTID': 'OBJECTID', 'ID': 'Precinct', 'GlobalID': 'GlobalID', 'Shape__Are': 'Shape__Are', 'Shape__Len': 'Shape__Len', 'Dem State Representative Dist 108-results-Miami-Dade_Daphne Campbell': 'Campbell', 'Dem State Representative Dist 108-results-Miami-Dade_Dinah J. Escarment': 'Escarment', 'Dem State Representative Dist 108-results-Miami-Dade_Peter Walsh': 'Walsh', 'Dem State Representative Dist 108-results-Miami-Dade_Winner': 'Winner', 'Dem State Representative Dist 108-results-Miami-Dade_Daphne Campbell %': 'Campbell %', 'Dem State Representative Dist 108-results-Miami-Dade_Dinah J. Escarment %': 'Escarment %', 'Dem State Representative Dist 108-results-Miami-Dade_Peter Walsh %': 'Walsh %', });
lyr_StateRepDist109BushIII_6.set('fieldAliases', {'fid': 'fid', 'OBJECTID': 'OBJECTID', 'ID': 'Precinct', 'GlobalID': 'GlobalID', 'Shape__Are': 'Shape__Are', 'Shape__Len': 'Shape__Len', 'Dem State Representative Dist 109-results-Miami-Dade_Broadway Harewood': 'Harewood', 'Dem State Representative Dist 109-results-Miami-Dade_James Bush III': 'Bush III', 'Dem State Representative Dist 109-results-Miami-Dade_John H. Taylor Jr.': 'Taylor Jr', 'Dem State Representative Dist 109-results-Miami-Dade_Satin Fye': 'Fye', 'Dem State Representative Dist 109-results-Miami-Dade_Winner': 'Winner', 'Dem State Representative Dist 109-results-Miami-Dade_Broadway Harewood %': 'Harewood %', 'Dem State Representative Dist 109-results-Miami-Dade_James Bush III %': 'Bush III %', 'Dem State Representative Dist 109-results-Miami-Dade_John H. Taylor Jr. %': 'Taylor Jr %', 'Dem State Representative Dist 109-results-Miami-Dade_Satin Fye %': 'Fye %', });
...
lyr_2024PresidentMiamiDadeHarris_2.set('fieldLabels', {'OBJECTID': 'hidden field', 'ID': 'inline label - always visible', 'GlobalID': 'hidden field', 'Shape__Are': 'hidden field', 'Shape__Len': 'hidden field', 'President and Vice President-results-Miami-Dade_Chase Oliver': 'hidden field', 'President and Vice President-results-Miami-Dade_Claudia De la Cruz': 'hidden field', 'President and Vice President-results-Miami-Dade_Donald J. Trump': 'inline label - always visible', 'President and Vice President-results-Miami-Dade_Jill Stein': 'hidden field', 'President and Vice President-results-Miami-Dade_Kamala D. Harris': 'inline label - always visible', 'President and Vice President-results-Miami-Dade_Peter Sonski': 'hidden field', 'President and Vice President-results-Miami-Dade_Randall Terry': 'hidden field', 'President and Vice President-results-Miami-Dade_Winner': 'inline label - always visible', 'President and Vice President-results-Miami-Dade_Chase Oliver %': 'hidden field', 'President and Vice President-results-Miami-Dade_Claudia De la Cruz %': 'hidden field', 'President and Vice President-results-Miami-Dade_Donald J. Trump %': 'inline label - always visible', 'President and Vice President-results-Miami-Dade_Jill Stein %': 'hidden field', 'President and Vice President-results-Miami-Dade_Kamala D. Harris %': 'inline label - always visible', 'President and Vice President-results-Miami-Dade_Peter Sonski %': 'hidden field', 'President and Vice President-results-Miami-Dade_Randall Terry %': 'hidden field', });
lyr_2026SenatePrimaryMiamiDadeNixon_3.set('fieldLabels', {'ID': 'inline label - always visible', 'DEM United States Senator-results-Miami-Dade_Alex Vindman': 'inline label - always visible', 'DEM United States Senator-results-Miami-Dade_Angie Nixon': 'inline label - always visible', 'DEM United States Senator-results-Miami-Dade_Winner': 'inline label - always visible', 'DEM United States Senator-results-Miami-Dade_Alex Vindman %': 'inline label - always visible', 'DEM United States Senator-results-Miami-Dade_Angie Nixon %': 'inline label - always visible', });
...
lyr_StateRepDist108Escarment_5.set('fieldLabels', {'fid': 'hidden field', 'OBJECTID': 'hidden field', 'ID': 'inline label - always visible', 'GlobalID': 'hidden field', 'Shape__Are': 'hidden field', 'Shape__Len': 'hidden field', 'Dem State Representative Dist 108-results-Miami-Dade_Daphne Campbell': 'inline label - always visible', 'Dem State Representative Dist 108-results-Miami-Dade_Dinah J. Escarment': 'inline label - always visible', 'Dem State Representative Dist 108-results-Miami-Dade_Peter Walsh': 'inline label - always visible', 'Dem State Representative Dist 108-results-Miami-Dade_Winner': 'inline label - always visible', 'Dem State Representative Dist 108-results-Miami-Dade_Daphne Campbell %': 'inline label - always visible', 'Dem State Representative Dist 108-results-Miami-Dade_Dinah J. Escarment %': 'inline label - always visible', 'Dem State Representative Dist 108-results-Miami-Dade_Peter Walsh %': 'inline label - always visible', });
lyr_StateRepDist109BushIII_6.set('fieldLabels', {'fid': 'hidden field', 'OBJECTID': 'hidden field', 'ID': 'inline label - always visible', 'GlobalID': 'hidden field', 'Shape__Are': 'hidden field', 'Shape__Len': 'hidden field', 'Dem State Representative Dist 109-results-Miami-Dade_Broadway Harewood': 'inline label - always visible', 'Dem State Representative Dist 109-results-Miami-Dade_James Bush III': 'inline label - always visible', 'Dem State Representative Dist 109-results-Miami-Dade_John H. Taylor Jr.': 'inline label - always visible', 'Dem State Representative Dist 109-results-Miami-Dade_Satin Fye': 'inline label - always visible', 'Dem State Representative Dist 109-results-Miami-Dade_Winner': 'inline label - always visible', 'Dem State Representative Dist 109-results-Miami-Dade_Broadway Harewood %': 'inline label - always visible', 'Dem State Representative Dist 109-results-Miami-Dade_James Bush III %': 'inline label - always visible', 'Dem State Representative Dist 109-results-Miami-Dade_John H. Taylor Jr. %': 'inline label - always visible', 'Dem State Representative Dist 109-results-Miami-Dade_Satin Fye %': 'inline label - always visible', });
